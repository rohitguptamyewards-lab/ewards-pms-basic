...
CMD php artisan config:cache && php artisan route:cache && php artisan view:cache && (php artisan migrate --force 2>&1 || echo "Migrations completed with warnings - tables may already exist") && php artisan serve --host=0.0.0.0 --port=${PORT:-10000}
