...
<body style="font-family: Arial, sans-serif; background: #f5f5f5; padding: 20px;">
    <div style="max-width: 500px; margin: 0 auto; background: white; border-radius: 8px; padding: 24px; border: 1px solid #e5e5e5;">
        <h2 style="color: #4e1a77; margin-top: 0;">Project Stage Updated</h2>
        <p>The stage has been updated on:</p>
        ...
        <p>New stage: <strong>{{ str_replace('_', ' ', ucwords($newStage, '_')) }}</strong></p>
        <p style="color: #666; font-size: 14px;">Changed by: {{ $changedBy }}</p>
